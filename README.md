...
![Coverage](https://github.com/BroARD/avito-tech-2024/blob/main/coverage.svg)


Описание Сервиса:

    Backend-сервис, с помощью которого пользователь сможет продать квартиру, загрузив объявление Авито. 
